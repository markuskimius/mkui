...
const OUTLINE = {
  ...
  // A message box's kind (widgets/mkui-dialog.js): Lucide info,
  // circle-check, triangle-alert, octagon-alert, circle-help.
  ...
  // Lucide copy: the sheet in front, the one behind it peeking out.
  copy: [
    "M10 8h10a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2z",
    "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",
  ],
  // Record undo / redo (Lucide undo-2 / redo-2): a hooked arrow, mirrored.
