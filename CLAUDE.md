...
Numeric alignment: all-numeric columns right-align, per-cell padding (`--mkui-num-pad`, ch) lining the decimals up (`colStats.maxFrac`), dropdown too. Flashes `mkui-flash-in`/`-out`/`-update`; each pane gets a unique `subid`.
